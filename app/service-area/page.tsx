      ...
      <div className="section">
        <div className="container-page grid gap-10 lg:grid-cols-[1fr_400px]">
          <div className="space-y-10">
            <section>
              <h2 className="text-step-2">Primary cities</h2>
                  ...
                  <li key={c.slug} className="py-4">
                    <div className="flex flex-wrap items-baseline justify-between gap-2">
                      <Link
                        ...
                        className="text-step-1 font-semibold text-brand-blue-deep hover:underline"
                      >
                        {c.name}, CO
                      </Link>
            ...
            <section>
              <h2 className="text-step-2">Also serving</h2>
              <p className="mt-2 text-muted">
            ...
            <section>
              <h2 className="text-step-2">Parker neighbourhoods</h2>
              <p className="mt-2 text-muted">
          ...
          <aside className="space-y-5">
            ...
            <div className="card p-5 text-[0.95rem]">
              ...
              <a
                ...
                className="mt-2 inline-block font-semibold text-brand-blue-deep"
              >
