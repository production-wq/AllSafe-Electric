---
title: Transform your Centennial backyard with outdoor lighting
description: Path lights, uplighting, and a switched holiday-light circuit, all built for Colorado weather. What works, what lasts, and what to plan before the patio.
...
A few well-aimed uplights on the corners of the house, a specimen tree, or a stone feature give the property depth after dark. The trick is restraint: two or three good fixtures aimed properly beat a dozen fighting each other. We plan uplighting on site at dusk, because you cannot judge aim and spread in daylight.

## Security and motion

Motion floods are useful when they cover the right area and stop at the property line. The common problem is a flood that lights up the neighbour's bedroom or never worked in the first place. We re-aim, re-wire, or replace them so they do the job without the nuisance.

## The holiday-light circuit
...
If you are pouring a patio, building a deck, or adding a pergola, get the conduit and the boxes in before the finishes go on. Retrofitting lighting into a finished hardscape costs several times what it costs to rough it in first.

## HOA note

Several Centennial-area communities have design review for exterior work. We site and spec the lighting to meet the guidelines; you handle the submission, or we can point you to what the association needs.

Ready to light the yard? [Get a free estimate](/outdoor-lighting/) or call (303) 648-1934.
